...
class Toast(ctk.CTkToplevel):
    def __init__(self, master, message: str, type: str = "info", duration: int = 2000):
        ...
        icon_label = ctk.CTkLabel(frame, text=icon, text_color=color,font=("Arial", 18), width=32)
        icon_label.grid(row=0, column=0, padx=(8, 8), pady=12)

        # message
        message_label = ctk.CTkLabel(frame, text=message, font=("Helvetica", 14), text_color="black", anchor="w", justify="left")
